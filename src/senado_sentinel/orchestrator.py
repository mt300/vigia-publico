...
from senado_sentinel.config import ANTHROPIC_API_KEY, DB_PATH
from senado_sentinel.db import repository as repo
from senado_sentinel.db.connection import get_connection, run_migrations
from senado_sentinel.detection.llm_analysis import processar_discursos_mes
from senado_sentinel.detection.statistical import rodar_regras_estatisticas
from senado_sentinel.ingestion.incremental import mes_referencia_padrao, run_incremental
